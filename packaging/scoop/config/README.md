...
- `manifest.json` is a template to publish into a Scoop bucket and uses placeholders for `{{version}}` and `SHA256_PLACEHOLDER_WINDOWS_X86_64` (and others where applicable) which should be replaced by the release script/CI.
